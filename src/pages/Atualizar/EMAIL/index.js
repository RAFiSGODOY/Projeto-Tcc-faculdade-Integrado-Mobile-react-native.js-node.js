...
const onSubmit = async () => {
    setIsLoading(true);
        try {
            ...
            showAndHideSuccess('E-mail Alterado com Sucesso!');
            setIsLoading(false);
        } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInUp" delay={200} style={styles.containerform}>
        ...
        <Feather name={'mail'} size={22} color="#005C58" style={styles.PinEmail}/>
        <TextInput
          placeholder={user}
        ...
        <Text style={styles.text2}>E-mail usado para login na plataforma ou até mesmo para que a Empresa entre em contato com você.</Text>
