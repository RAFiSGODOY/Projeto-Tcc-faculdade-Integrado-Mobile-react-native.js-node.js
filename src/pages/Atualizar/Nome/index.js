...
const onSubmit = async () => {
    setIsLoading(true);
        try {
            ...
            showAndHideSuccess('Nome Alterado com Sucesso!');
            setIsLoading(false);
        } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInUp" delay={200} style={styles.containerform}>
        ...
        <Feather name={'user'} size={22} color="#005C58" style={styles.PinEmail}/>
        <TextInput
          placeholder={user}
        ...
        <Text style={styles.text2}>Nome de Identificação Pessoal (Mostrado para as Empresas que o usuário assinar o contrato)</Text>
