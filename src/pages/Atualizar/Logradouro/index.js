...
const onSubmit = async () => {
    setIsLoading(true);
        try {
            ...
            showAndHideSuccess('Endereço Alterado com Sucesso!');
            setIsLoading(false);
        } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInUp" delay={200} style={styles.containerform}>
        ...
        <Text style={styles.text2}>Endereço da sua residência (Casa), sempre atualize este campo caso troque de endereço.</Text>
