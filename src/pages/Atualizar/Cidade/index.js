...
const onSubmit = async () => {
    setIsLoading(true);
        try {
            ...
            showAndHideSuccess('Cidade Alterada com Sucesso!');
            setIsLoading(false);
        } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInUp" delay={200} style={styles.containerform}>
        ...
        <Text style={styles.text2}>Cidade onde fica localizada sua residência (Casa), sempre atualize este campo caso troque de endereço.</Text>
